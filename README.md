...
It does **not** write files, install software, or send data over the network. Results are printed as JSON to your terminal. You can read the [script source](https://github.com/beorn/terminfo.dev/tree/main/packages/terminfo.dev) before running it.
