...
Created by [Bjørn Stabell](https://beorn.codes), serial entrepreneur and open-source developer. terminfo.dev grew from the need to understand which terminal features could be safely relied upon when building [Silvery](https://silvery.dev) and a suite of AI-powered productivity tools.
